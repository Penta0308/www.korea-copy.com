                ...
                foreach($structure->parts as $part){
                    ...
                    switch(strtolower($part->ctype_primary)){
                        ...
                        case "application":
							...
							if ($part->ctype_parameters['name'] == $ss) {
...
if (file_exists("C:/www.korea-copy.com/minju/ftpdata/Munhak ".date("Y.m.d", strtotime("$p day")).".pdf")
 && file_exists("C:/www.korea-copy.com/minju/ftpdata/Munhak ".date("Y-n-j", strtotime("$p day")).".zip")) {
	rename(
	  "C:/www.korea-copy.com/minju/ftpdata/Munhak ".date("Y.m.d", strtotime("$p day")).".pdf",
	  "C:/www.korea-copy.com/munhak/".date("Y")."/data/Munhak ".date("Y.m.d", strtotime("$p day")).".pdf"
	);
	rename(
	  "C:/www.korea-copy.com/minju/ftpdata/Munhak ".date("Y-n-j", strtotime("$p day")).".zip",
	  "C:/www.korea-copy.com/minju/Munhak ".date("Y-n-j", strtotime("$p day")).".zip"
	);

	proc_feed2("Munhak ".date("Y-n-j", strtotime("$p day")).".zip");

	rename(
	  "C:/www.korea-copy.com/minju/Munhak ".date("Y-n-j", strtotime("$p day")).".zip",
	  "C:/www.korea-copy.com/finish/Munhak ".date("Y-n-j", strtotime("$p day")).".zip"
	);
}
...
//proc_feed2("Munhak ".date("Y-n-j") . ".zip");
//proc_feed("Minju 2019-3-6.zip");
//proc_feed2("Munhak 2020-4-4.zip");
print "done.\n";
exit;
